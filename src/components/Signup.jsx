...
//         <h1 className="text-white text-7xl">Sign-Up Page</h1>
//       </div>
...
//   <div className="flex flex-col items-center bg-black bg-opacity-50 text-white w-1/4 mx-auto mt-24 p-10 rounded-xl">
//     <div className="flex flex-col space-y-4 w-full">
//       <label>
//         Trainer Name:
//           <input
...
//     <input type="checkbox" required />
//     <div className="text-white">I agree with privacy and policy</div>
//   </div>
